...
//
//
//    [getUserInfo getUserInput : self onDone:^(NSString * wayContact,NSString* fakePlace,NSString* comments) {
//
...
//        [report printReport];
//
//        NSLog(@"way to contact :%@",wayContact);
//        NSLog(@"fake place :%@",fakePlace);
